...
class LiteLLMResponsesTransformationHandler(CompletionTransformationBridge):
    ...
    @classmethod
    def _recover_output_items_from_raw_sse(  # noqa: PLR0915
    ...
    def _get_output_items_for_chat_response(
        self,
        raw_response: Any,
    ...
    def transform_response(  # noqa: PLR0915
        ...
        output_items = self._get_output_items_for_chat_response(
    ...
    def _map_reasoning_effort(
        ...
        if reasoning_effort == "none":
            ...
            return Reasoning(effort="ultra", summary="detailed") if auto_summary_enabled else Reasoning(effort="ultra")  # type: ignore[typeddict-item]
