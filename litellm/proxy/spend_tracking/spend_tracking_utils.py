...
def _get_spend_logs_metadata(
    ...
    if metadata is None:
        return SpendLogsMetadata(
            ...
            chatgpt_auth_profile=None,
            chatgpt_requested_service_tier=None,
            chatgpt_effective_service_tier=None,
            chatgpt_fast_mode_requested=None,
            chatgpt_fast_mode_effective=None,
            chatgpt_profile_allow_fast_mode=None,
            chatgpt_virtual_key_allow_fast_mode=None,
            chatgpt_fast_mode_allowed=None,
            chatgpt_requested_reasoning_effort=None,
            chatgpt_effective_reasoning_effort=None,
            chatgpt_reasoning_effort_action=None,
            chatgpt_reasoning_effort_policy_source=None,
            chatgpt_reasoning_effort_policy_applied=None,
